...
export default function CryptoNewsCard() {
  ...
  const handleCardClick = () => {
    // Navigate to a detailed news page or any other destination
    navigate("/news/crypto-enforcement-unit")
  }
  ...
  return (
    <div className="h-auto px-4 md:px-10 lg:px-24 py-20 text-white relative group">
      ...
      />
      <div className="max-w-7xl mx-auto relative mt-6 cursor-pointer card-shadow transform transition-transform duration-300 ease-in-out hover:-translate-y-2" onClick={handleCardClick}>
